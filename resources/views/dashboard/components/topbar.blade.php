    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter">{{ count($latestTasks) }}</span>
            </a>
            <!-- Dropdown - Alerts -->
            ...
            <h6 class="dropdown-header">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{route('dashboard')}}">
                    ...
                    <div>
                        <div class="small text-gray-500">{{$taskd->created_at}}</div>
                        <span class="font-weight-bold">New Task: {{$taskd->title}}</span>
                    </div>
                </a>
                @endforeach
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle"
                    src="{{asset('assets/dashboard/img/undraw_profile.svg') }}" width="160" height="160">
                {{-- <div class="status-indicator bg-success"></div> --}}
            </a>
